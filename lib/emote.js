...
var silentFlags = /^--version$|^--emoteDir|^--whoami$/;
...
var commandMap = {
    ...
    download: function() { 
        mmsLogin(function() {
            download.getResourceAndWriteFiles(command[1],command[2],function() {
                // Downloaded resources that were unzipped *may* have overwritten
                ...
                if(common.global.projectProfile) {
    ...
    info: function() {
        ...
        console.log("username: " + mmsCreds.username);
        console.log("server: " + mmsCreds.server);
...
function main() {
    var argv = optimist.usage('Usage: $0')
        ...
        .options('seperator', {alias:'S', describe: 'Column seperator for list command'})
